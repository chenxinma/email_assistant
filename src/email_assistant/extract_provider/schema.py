"""Example qwen schema implementation for provider plugins."""
...
class QwenProviderSchema(lx.core.schema.BaseSchema):
    ...
    def from_examples(
        ...
        return cls(schema_dict, strict_mode=False) # for DeepSeek-R1-Distill-Qwen-32B, strict_mode=False is required
